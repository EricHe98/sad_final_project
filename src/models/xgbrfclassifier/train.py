...
from xgboost import XGBRanker, XGBRFClassifier
...
def __main__():
    ...
    with mlflow.start_run(run_name='{}_lambdamart'.format(args.run_type)):
        ...
        model = XGBRFClassifier(verbosity=2, n_jobs=8, n_estimators=10)
        ...
        mlflow.xgboost.log_model(model, 'xgbrfclassifier.json')
